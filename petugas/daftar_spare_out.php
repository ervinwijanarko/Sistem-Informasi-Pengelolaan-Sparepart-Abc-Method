...
<table class="table table-bordered table-hover">
	...
	include("../connect.php");
	$no=1;
    $sql = "SELECT*FROM sparepat  WHERE stok > 0 ORDER BY kd_sparepat";
	...
	?>  
            ...
            <td><a href="#" onClick="sendValue('<?php echo $data['kd_sparepat']; ?>','<?php echo $data['nama']; ?>','<?php echo $data['stok']; ?>');"><span class="btn btn-success"><i class="icon-edit"></i>Pilih</span></a></td>   
      </tr>
    <?php
    endforeach;
    ?>
